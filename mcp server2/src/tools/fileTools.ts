...
export class FileTools {
  ...
  private editFile(): MCPTool {
    return {
      ...
      handler: async (args: { filePath: string; edits: any[] }) => {
        try {
  ...
  private listFiles(): MCPTool {
    return {
      ...
      handler: async (args: { directory?: string; pattern?: string }) => {
        try {
  ...
  private searchInFiles(): MCPTool {
    return {
      ...
      handler: async (args: { searchTerm: string; filePattern?: string }) => {
        try {
  ...
  private startFileWatching(): MCPTool {
    return {
      ...
      handler: async (args: { patterns?: string[] }) => {
        try {
  ...
  private analyzeFileChanges(): MCPTool {
    return {
      ...
      handler: async (args: { changes: any[] }) => {
        try {
